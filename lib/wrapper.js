...
//      })
	  ...
	  .default('script param', 0)
      .alias('p','param')
      .describe('param','Parameter to be passed to hosted script.')
...
var launch = function(logLevel, msg) {
  ...
  var arguments = [argv.p]
  child = fork(script,arguments,opts);
...
// Launch the process
launch('info', 'Starting ' + argv.f+ ' '+ argv.p);